...
class ActivityForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "distance_from_resort": forms.NumberInput(
                attrs={
                    "class": "form-control",
            ...
            "travel_time_from_resort": forms.NumberInput(
                attrs={
                    "class": "form-control",
            ...
            "pre_trip_priority": forms.NumberInput(
                attrs={
                    "class": "form-control",
...
class ActivityRatingForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "post_trip_notes": forms.Textarea(
                attrs={
                    "class": "form-control",
                    "rows": 4,
