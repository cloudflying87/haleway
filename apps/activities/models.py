...
class Activity(models.Model):
    ...
    trip = models.ForeignKey(
        "trips.Trip", on_delete=models.CASCADE, related_name="activities", verbose_name=_("trip")
    )
    ...
    pre_trip_priority = models.PositiveIntegerField(
        _("priority"), default=0, help_text=_("Lower numbers = higher priority. 0 = unranked")
    )
    ...
    post_trip_notes = models.TextField(
        _("post-trip notes"), blank=True, help_text=_("Reflections, tips, or notes after visiting")
    )
    is_favorite = models.BooleanField(
        _("favorite"), default=False, help_text=_("Flag activities you would do again")
    )
