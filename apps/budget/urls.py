...
urlpatterns = [
    ...
    path(
        "<uuid:trip_pk>/category/create/",
        views.BudgetCategoryCreateView.as_view(),
        name="category_create",
    ),
    path(
        "category/<uuid:pk>/edit/", views.BudgetCategoryUpdateView.as_view(), name="category_update"
    ),
    path(
        "category/<uuid:pk>/delete/",
        views.BudgetCategoryDeleteView.as_view(),
    ...
    # Add from Activity
    path(
        "add-from-activity/<uuid:activity_pk>/",
