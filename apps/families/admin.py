...
class FamilyMemberAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Member Information", {"fields": ("family", "user", "role")}),
        ("Metadata", {"fields": ("id", "joined_at"), "classes": ("collapse",)}),
    )
...
class FamilyInvitationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Invitation Details", {"fields": ("family", "email", "status", "invited_by")}),
        (
            "Token & Expiration",
            {"fields": ("token", "created_at", "expires_at"), "classes": ("collapse",)},
        ),
    ...
    def status_badge(self, obj):
        ...
        colors = {"pending": "#ffc107", "accepted": "#28a745", "expired": "#dc3545"}
