...
class FamilyMember(models.Model):
    ...
    family = models.ForeignKey(
        Family, on_delete=models.CASCADE, related_name="members", verbose_name=_("family")
    )
...
class FamilyInvitation(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    family = models.ForeignKey(
        Family, on_delete=models.CASCADE, related_name="invitations", verbose_name=_("family")
    )
    email = models.EmailField(_("email address"))
    token = models.CharField(_("invitation token"), max_length=100, unique=True, default=uuid.uuid4)
