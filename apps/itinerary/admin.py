...
class DailyItineraryAdmin(admin.ModelAdmin):
    ...
    list_filter = ["date", "trip__status", "created_at"]
    search_fields = ["title", "notes", "trip__name", "trip__destination_name", "activity__name"]
    readonly_fields = ["id", "created_at", "updated_at"]
    fieldsets = (
        ("Basic Information", {"fields": ("trip", "date", "activity", "title", "notes")}),
        ("Timing", {"fields": ("time_start", "time_end", "order")}),
        (
            "Metadata",
