...
class TripPhoto(models.Model):
    ...
    trip = models.ForeignKey(
        "trips.Trip", on_delete=models.CASCADE, related_name="photos", verbose_name=_("trip")
    )
    ...
    image = models.ImageField(upload_to="trip_photos/%Y/%m/%d/", verbose_name=_("photo"))
    caption = models.TextField(
        blank=True, verbose_name=_("caption"), help_text=_("Optional description of the photo")
    )
...
class DailyJournal(models.Model):
    ...
    date = models.DateField(verbose_name=_("date"), help_text=_("Which day of the trip?"))
    content = models.TextField(
        verbose_name=_("journal entry"), help_text=_("What happened today? How was the experience?")
    )
