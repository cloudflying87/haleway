...
urlpatterns = [
    ...
    path(
        "trip/<uuid:trip_pk>/photos/upload/",
        views.TripPhotoCreateView.as_view(),
        name="photo_upload",
    ),
    ...
    path(
        "trip/<uuid:trip_pk>/journal/new/",
        views.DailyJournalCreateView.as_view(),
        name="journal_create",
    ),
    ...
    path(
        "journal/<uuid:pk>/delete/", views.DailyJournalDeleteView.as_view(), name="journal_delete"
    ),
]
