...
urlpatterns = [
    ...
    # Category management
    path(
        "trip/<uuid:trip_pk>/category/create/",
        views.NoteCategoryCreateView.as_view(),
        name="category_create",
    ),
    path(
        "category/<uuid:pk>/edit/", views.NoteCategoryUpdateView.as_view(), name="category_update"
    ),
    path(
        "category/<uuid:pk>/delete/", views.NoteCategoryDeleteView.as_view(), name="category_delete"
    ),
]
