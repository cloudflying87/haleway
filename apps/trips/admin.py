...
class TripAdmin(admin.ModelAdmin):
    ...
    list_display = ['name', 'destination_name', 'family', 'start_date', 'end_date', 'duration', 'status', 'status_badge']
    ...
    fieldsets = (
        ('Trip Details', {
            'fields': ('family', 'name', 'destination_name', 'status')
        }),
        ('Dates', {
