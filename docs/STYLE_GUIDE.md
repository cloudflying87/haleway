...
**Project Name**: haleway *(e.g., "AirlineOps", "MedTracker")*
...
**Primary Color**: #2e86ab *(Main brand color for buttons, links, headers)*
**Secondary Color**: #f4e8c1 *(Supporting color for accents, highlights)*
**Accent Color**: #ff6b6b *(Special indicators, badges, alerts)*
